  ...
  useEffect(() => {
    if (selectedControl) {
      if ((selectedControl as FormLayoutComponentChildrenType).items) {
        setUpdatedItem({
          ...selectedControl,
          items: JSON.parse(JSON.stringify((selectedControl as FormLayoutComponentChildrenType).items)),
        });
      } else {
            ...
            <>
              <div className="main-form">
                <form onSubmit={onContainerFormSubmit} style={{ minWidth: "100%" }}>
                  ...
                  <div>
                    <TextField label="Container Heading" name="heading" value={containerUpdatedItem.heading} onChange={handleChange} style={textboxStyle} />
                  </div>
                  <div>
                    <TextField label="Container Sub-Heading" name="subHeading" value={containerUpdatedItem.subHeading} onChange={handleChange} style={textboxStyle} />
                  </div>
                  <input type="submit" className="btn btn-light btn-shadow m-t-20 m-r-10" value="Update Data" />
                  <input
                    type="button"
            ...
            <>
              <div className="main-form">
                <form onSubmit={onFormSubmit} style={{ minWidth: "100%" }}>
                  ...
                  <div>
                    <TextField label="Field Label Name" name="labelName" value={childUpdatedItem.labelName} onChange={handleChange} style={textboxStyle} />
                  </div>
            ...
            <div>
              <FormControl style={{minWidth:'100%'}}>
                ...
                >
                  ...
                  {childUpdatedItem.controlName === FormControlNames.INPUTTEXTFIELD || childUpdatedItem.controlName === FormControlNames.INPUTMULTILINE || childUpdatedItem.controlName === FormControlNames.CHECKBOX ? (
                    <>
                      <div>
                        <TextField label="Field Placeholder" name="placeholder" value={childUpdatedItem.placeholder} onChange={handleChange} style={textboxStyle} />
                      </div>
                    </>
                  ) : (
                    ""
                  ...
                  <div>
                    <TextField label="Field Description" name="description" value={childUpdatedItem.description} onChange={handleChange} multiline style={textboxStyle} />
                  </div>
                  <div className="m-t-20 p-l-0">
                    <FormControlLabel control={<Checkbox checked={isUpdatedItemRequired} name="required" onChange={handleCheckChange} />} label="Required" />
                  </div>
                  {childUpdatedItem.controlName === FormControlNames.RADIOGROUP || childUpdatedItem.controlName === FormControlNames.SELECTDROPDOWN || childUpdatedItem.controlName === FormControlNames.CHECKLIST ? (
                    <>
                      <h6>List Items</h6>
                      <ManageItemsListComponent addItemInList={addItemInList} editIteminList={editIteminList} deleteItemFromList={deleteItemFromList} items={childUpdatedItem.items} />
                    </>
                  ) : null}
                  <input type="submit" className="btn btn-light btn-shadow m-t-20 m-r-10" value="Update Data" />
                  <input
                ...
                <form onSubmit={onMoveControlFormSubmit} style={{ minWidth: "100%" }}>
                  ...
                  <div>
                    <FormControl style={{ minWidth: "100%" }}>
                      ...
                      <Select name="containerId" value={moveControlObj && moveControlObj.containerId ? moveControlObj.containerId : ""} onChange={handleMoveControlSelectChange}>
                  ...
                  <div>
                    <FormControl style={{ minWidth: "100%" }}>
                      ...
                      <Select name="position" value={moveControlObj && moveControlObj.position ? moveControlObj.position : ""} onChange={handleMoveControlSelectChange}>
                        {getPositions()}
                      </Select>
                    </FormControl>
                  </div>
                  <input type="submit" className="btn btn-light btn-shadow m-t-20 m-r-10" value="Move" />
                  <input
                    type="button"
                    className="btn btn-light btn-shadow m-t-20 m-l-0"
                    value="Cancel"
