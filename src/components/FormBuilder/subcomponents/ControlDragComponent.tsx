...
import { FormLayoutComponentChildrenType, FormLayoutComponentContainerType, FormLayoutComponentsType } from "../../../types/FormTemplateTypes";
...
const ControlDragComponent: FunctionComponent<ControlDragComponentProps> = (props) => {
  ...
  return (
    <>
      <div ref={drag} style={{ opacity, cursor: "move", position: isDragging ? "absolute" : "relative" }} className="d-flex align-items-center justify-content-center btn btn-light btn-shadow w-100 my-2">
